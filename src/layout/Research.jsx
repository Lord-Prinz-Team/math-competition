	...
	return (
		<section className={classes.research} id="research">
			...
			<div className={classes.container}>
				...
				<Paragraph className={`${classes["paragraph--1"]} u-margin-bottom-big`}>Mechanizm został zbadany przez dyrektora greckiego Narodowego Muzeum Numizmatycznego - Ioannisowi  Svoronosowi oraz filologowi Adolphowi Wilhelmowi z Austriackiego Instytutu Archeologicznego w Atenach. 
				...
				<Paragraph className={`${classes["paragraph--2"]} u-margin-bottom-big`}>
			...
			<Heading size="3" className={`${classes["heading--3"]} u-margin-bottom-small`}>
				...
				<Paragraph className={`${classes["paragraph--3"]} u-margin-bottom-big`}>
				...
				<Paragraph className={`${classes["paragraph--4"]} u-margin-bottom-big`}>
				...
				<Paragraph className={`${classes["paragraph--5"]} u-margin-bottom-big`}>
